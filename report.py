...
def generate_report(data, district, source_web):
    ...
    size_price_maps = {'r1': {'count': 0, 'prices': [], 'avg': 0, 'p5': 0, 'p9': 0, 'variance': 0, 'percentile': 0},
                       ...
                       'r6': {'count': 0, 'prices': [], 'avg': 0, 'p5': 0, 'p9': 0, 'variance': 0, 'percentile': 0},
                       'r7': {'count': 0, 'prices': [], 'avg': 0, 'p5': 0, 'p9': 0, 'variance': 0, 'percentile': 0},
                       'r8': {'count': 0, 'prices': [], 'avg': 0, 'p5': 0, 'p9': 0, 'variance': 0, 'percentile': 0},
                       'r9': {'count': 0, 'prices': [], 'avg': 0, 'p5': 0, 'p9': 0, 'variance': 0, 'percentile': 0},
                       'r10': {'count': 0, 'prices': [], 'avg': 0, 'p5': 0, 'p9': 0, 'variance': 0}}
    ...
    price_count['r1_percentile'] = '%0.3f' % float(price_count['r1'] * 100 / price_count_total)
    price_count['r2_percentile'] = '%0.3f' % float(price_count['r2'] * 100 / price_count_total)
    price_count['r3_percentile'] = '%0.3f' % float(price_count['r3'] * 100 / price_count_total)
    price_count['r4_percentile'] = '%0.3f' % float(price_count['r4'] * 100 / price_count_total)
    price_count['r5_percentile'] = '%0.3f' % float(price_count['r5'] * 100 / price_count_total)
    price_count['r6_percentile'] = '%0.3f' % float(price_count['r6'] * 100 / price_count_total)
    price_count['r7_percentile'] = '%0.3f' % float(price_count['r7'] * 100 / price_count_total)
    price_count['r8_percentile'] = '%0.3f' % float(price_count['r8'] * 100 / price_count_total)
